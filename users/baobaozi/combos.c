...
const uint16_t PROGMEM qua_combo[] = {MS(Z), LT3(X), COMBO_END};
const uint16_t PROGMEM pen_combo[] = {LT2(W), KC_F, KC_P, COMBO_END};
const uint16_t PROGMEM qwer_combo[] = {LT1(Q), LT2(W), KC_E, KC_R, COMBO_END}; // qwerty
...
combo_t key_combos[] = {
    ...
    [CHD_TGPRI] = COMBO_ACTION(tgpri_combo),
